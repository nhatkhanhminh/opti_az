...
import { useClaimContract, useClaimContractDemo, useDataContractDemo } from "@/hooks/useContract"
...
export default function MyStaking() {
  ...
  const contractData = useDataContractDemo();
  const contractClaim = useClaimContractDemo();
